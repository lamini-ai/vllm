...
def generate_and_test(llm, mome_adapter_files):
    print("mome adapter created")
    assert do_sample(llm, mome_adapter_files, mome_id=0) == EXPECTED_NO_LORA_OUTPUT

    # print("lora 1")
    # assert do_sample(llm, mome_adapter_files, mome_id=1) == EXPECTED_LORA_OUTPUT

    # print("no lora")
    # assert do_sample(llm, mome_adapter_files, mome_id=0) == EXPECTED_NO_LORA_OUTPUT

    # print("lora 2")
    # assert do_sample(llm, mome_adapter_files, mome_id=2) == EXPECTED_LORA_OUTPUT
